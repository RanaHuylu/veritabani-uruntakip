...
namespace VeriTabaniProje
{
    ...
    {
        SqlConnection baglanti = new SqlConnection("Data Source=DESKTOP-KO6819R; Initial Catalog=Stok; Integrated Security=True");
        ...
        private void listele() //veritabınındaki kayıtların görüntülenmesi
        {
            baglanti.Open();
        ...
        { //SİL
            String t1 = textBox1.Text; //seçilen ssatırın malzeme kodunu alır
            baglanti.Open();
